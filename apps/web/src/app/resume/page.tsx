...
const Experience = dynamic(() => import("@/components/resume/experience").then(mod => ({ default: mod.Experience })), {
  loading: () => <div className="min-h-[600px] bg-black/50 animate-pulse rounded-xl" />,
});

const Education = dynamic(() => import("@/components/resume/education").then(mod => ({ default: mod.Education })), {
  loading: () => <div className="min-h-[400px] bg-black/50 animate-pulse rounded-xl" />,
});

const Skills = dynamic(() => import("@/components/resume/skills").then(mod => ({ default: mod.Skills })), {
  loading: () => <div className="min-h-[800px] bg-black/50 animate-pulse rounded-xl" />,
});

const Certifications = dynamic(() => import("@/components/resume/certifications").then(mod => ({ default: mod.Certifications })), {
